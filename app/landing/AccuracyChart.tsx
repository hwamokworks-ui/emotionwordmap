...
const SERIES: { key: string; label: string; color: string; values: (number | null)[] }[] = [
  { key: 'top1', label: '1순위 정확도', color: '#8F5A12', values: [23.3, 30.0, 36.7, 36.7, 36.7, 43.3, 36.7, 33.3, 40.0, 53.3] },
  { key: 'hit', label: '정답 포함 확률', color: '#1D6FD1', values: [null, 30.0, 50.0, 66.7, 60.0, 60.0, 56.7, 63.3, 60.0, 83.3] },
  { key: 'region', label: '지역 정확도', color: '#B8467A', values: [36.7, 43.3, 50.0, 53.3, 53.3, 53.3, 53.3, 50.0, 50.0, 63.3] },
];
    ...
    <div>
      ...
      <div className="mt-6 pt-5 max-w-[560px] mx-auto text-left" style={{ borderTop: '1px solid var(--border-hairline)' }}>
        ...
        <div className="text-[11.5px] text-taupe leading-relaxed space-y-1.5">
          ...
          <p><b className="text-parchment">후보 7개(최종)</b> — 다시 무조건 채우는 방식으로 돌아가되, 개수를 5개에서 7개로 늘려 그물을 넓힌 지금의 최종 방식.</p>
